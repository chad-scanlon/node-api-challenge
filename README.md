...
- Can by used to build RESTful APIs

- [x] Describe Middleware?
      Middleware is a typeof function that can get response and request objects and operate on them and/or trigger some kid of action
- [x] Describe a Resource?
      A resource is an object with a type, associated data, relationships to other resources, and a set of methods that operate on it- like POST, PUT, GET, DELETE
